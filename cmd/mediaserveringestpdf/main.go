...
import (
	...
	"github.com/je4/mediaserveringestpdf/v2/config"
	"github.com/je4/mediaserveringestpdf/v2/pkg/ingestpdf"
...
func main() {
	...
	if *cfg != "" {
		...
		cfgFile = "mediaserveringestpdf.toml"
	}
	conf := &MediaserverIngestPdfConfig{LocalAddr: ":0"}
	if err := LoadMediaserverIngestPdfConfig(cfgFS, cfgFile, conf); err != nil {
	...
	ingester, err := ingestpdf.NewIngester(
		dbClient,
		vfs,
